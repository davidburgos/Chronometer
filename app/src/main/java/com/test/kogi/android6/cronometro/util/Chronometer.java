package com.test.kogi.android6.cronometro.util;

/**
 * Created by DavidAlejandroBurgos
 */
...
public class Chronometer extends TextView {
  ...
  //  private SimpleDateFormat TimeFormatter = new SimpleDateFormat("dd:HH:mm:ss:SSS", Locale.US);
    ...
    public void pause(){
        mStarted = false;
        paused += SystemClock.elapsedRealtime() - mBase;
        updateRunning();
    }
    ...
    private void updateRunning() {
        ...
        if (running != mRunning) {
            if (running) {
                updateText(SystemClock.elapsedRealtime()+paused);
                dispatchChronometerTick();
